...
const Page = () => {
  ...
  const { leadStatus, successMessage, errorMessage } = useSelector(
    (state) => state.setting
  );
  ...
  const currentRecords = leadStatus.slice(
    indexOfFirstRecord,
    indexOfLastRecord
  );
              ...
              <tbody className="divide-y divide-gray-200">
                {currentRecords.map((row, i) => (
                  ...
                  >
                    ...
                    <td className="py-3 text-sm px-4 text-gray-500">
                      {capitalizeFirstLetter(row.status_name)}
                    </td>
                    <td className="py-3 text-sm px-4 text-gray-500">
                      {row.order}
                    </td>
