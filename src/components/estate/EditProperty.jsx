...
import { update_property, get_property, messageClear } from "@/store/estate";
...
const EditProperty = ({ id }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    street: "",
    street_number: "",
    public_address: "Hide street number",
    district: "",
    area: "",
    status: "",
    reference: "",
    ...
    capturer: "",
    commercial_manager: "",
    video_link: "", // ✅ Added video link to state
  });
  ...
  useEffect(() => {
    if (property) {
      setFormData({
        ...
        video_link: property.video_link || "", // ✅ Map video link
      });
    }
  }, [property]);
  ...
  return (
    <div className="w-full bg-white min-h-screen pb-24">
      <form onSubmit={handleSubmit} className="space-y-10">
        ...
        {/* SECTION 2: PROPERTY FEATURES (UPDATED LAYOUT) */}
        <section className="p-6">
          <h2 className="text-lg font-bold text-gray-800 mb-6 border-b pb-2">
            Property Features
          </h2>
        ...
        <div className="flex flex-col items-center justify-center mt-4">
          <button
            type="submit"
            disabled={loader}
            className="bg-green-600 hover:bg-green-700 disabled:bg-green-400 text-white px-24 py-2 rounded font-bold transition-all"
          >
