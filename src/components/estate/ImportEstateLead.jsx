...
const ImportEstateLead = ({ isOpen, setImportOpen }) => {
  ...
  const handleUpload = () => {
    ...
    dispatch(upload_estate_lead_file(file))
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <h2 className="text-lg font-semibold mb-4">Import Estate Leads</h2>
            ...
            <p className="text-xs text-gray-500 mt-4">
              ...
              <a href="/estate/estate_sellers.xlsx" className="text-blue-500 underline">
                Excel File Sample
              </a>
            </p>
            {/* RESULTS PANEL */}
...
export default ImportEstateLead;
