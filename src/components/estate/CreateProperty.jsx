    ...
    <div className="w-full bg-white min-h-screen pb-24">
      <form onSubmit={handleSubmit} className="space-y-10">
          ...
          <div className="overflow-hidden mb-4 rounded-xl border border-gray-200 bg-white shadow-sm transition-all hover:shadow-md">
            ...
            <div className="border-b border-gray-100 bg-gray-50/50 px-6 py-3">
              <p className="mt-1 text-base text-gray-600">
                Please provide the full address, including the city, street, and
                house number.
              </p>
            </div>
            ...
            <div className="px-6 py-4">
              <div className="w-full md:w-2/3 lg:w-1/2">
                <Input
                  ...
                  value={formData.full_address} // Changed from .province to match the name
        ...
        <div className="sticky bottom-0 z-50 flex flex-col items-center justify-center bg-white/95 py-3 border-t border-gray-200 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)] w-full mt-10">
          <button
            type="submit"
            className="bg-green-600 hover:bg-green-700 text-white px-30 py-2 rounded-lg font-bold text-lg shadow-md hover:shadow-lg transition-all transform hover:-translate-y-0.5"
          >
            Save
          </button>
        </div>
