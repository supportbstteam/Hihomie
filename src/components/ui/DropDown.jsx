    ...
    <div className={clsx("space-y-1 rounded-md text-black", className)}>
      ...
      <div className="relative">
        <select
          ...
          className={clsx(
            "text-light text-sm appearance-none font-normal font-heading w-full px-2 py-3 border pr-10 rounded-md focus:outline-none focus:ring-inset focus:ring-1 focus:ring-primary overflow-hidden",
